...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: 2VKJk33_wk8Z/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ripf8)}
      >
        <div className={classNames(projectcss.all, sty.freeBox___9ZHa7)}>
          <div className={classNames(projectcss.all, sty.freeBox___6SG8G)}>
            {p.renderPlasmicSlot({
