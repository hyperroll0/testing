...
import Avatar from "../../Avatar"; // plasmic-import: CHGurSZLr_3O/component
...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: A58cx1y4zmwI/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: -myQmL-TrqLJ/icon
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__z9O4R)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__gAQf)}
        >
          <div
            className={classNames(
              projectcss.all,
