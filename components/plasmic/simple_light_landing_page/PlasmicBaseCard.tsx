...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: NawQ_Lq11r3s/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__aWuaV, {
          [sty.freeBox__long__aWuaVaVr9R]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__cmpDe, {
            [sty.freeBox__long__cmpDEaVr9R]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__mQwd)}
                role={"img"}
              />
            ),
