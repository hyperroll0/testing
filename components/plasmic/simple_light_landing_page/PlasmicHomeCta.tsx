...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: NeD17rHpc4Z/css
...
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: NudpcdGpisYc/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ahJcr)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__obFTr)}
        >
          <TextInput
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        <div className={classNames(projectcss.all, sty.freeBox__jZ5A0)}>
          <SphereIcon
