...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: UiX6DexRCFI/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__qrOci, {
            [sty.freeBox__long__qrOcIxraIn]: hasVariant(
              variants,
              "long",
              "long"
            )
        ...
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__k53Om, {
              [sty.freeBox__long__k53OMxraIn]: hasVariant(
                variants,
                "long",
                "long"
              )
          ...
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg___1V3Ft)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___4ZRln, {
          [sty.freeBox__long___4ZRlNxraIn]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__dv6A, {
            [sty.freeBox__long__dv6AxraIn]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__pZ47N)}
                role={"img"}
              />
            ),
